...
import csv  
# My Librares
from student_grades_brown import *
sys.path.insert(1, '../')
...
print(onset_list[0:5], onsetStemSOP[0:5])
...
while student_index < numOfStudents:
 ...
 print( songList[stem_index] + " This is student number ", student_index+1, "Onset Len. length is ", len(sonsetIndex))
...
the_student_grades = returnGradesBrown()
