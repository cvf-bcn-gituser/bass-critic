...
def write_create_script(submissions, title, description, score_image_id, file_name):
    ...
    for s in submissions:
        ...
        visualizationTitle = "Visualization errors (#{id})"
        commentsTitle = "Exercise Comments (#{id})"
        visCommentsTitle = "Visualization Comments (#{id})"
...
###################################################################################
with open('l2ex1_leah.json') as outfile:
...
"""
process_exercise(
    submissions, "Lesson 2 - Picking", "l2ex1_leah_", description,
"1PYnuJaL0RhzBP3Tz8oS9aFPMvf07Rod4")

##################################################################################
with open('l1ex1_leah.json') as outfile:
    submissions = json.load(outfile)
description = """
...
"""
process_exercise(
    submissions, "Lesson 1 - Getting Started", "l1ex1_leah_", description,
"11jCI6fmRn6krv0adTWn9sCafhlFXyH_6")
##################################################################################
with open('l2ex2_leah.json') as outfile:
    submissions = json.load(outfile)
description = """
...
"""
process_exercise(
    submissions, "Lesson 2 - Strumming", "l2ex2_leah_", description,
"1ROAx7UzO6MVh_3ryR6TDZyIwYu-cmiCr")
###################################################################################
with open('l3ex1_leah.json') as outfile:
    submissions = json.load(outfile)
description = """
...
"""
process_exercise(
    submissions, "Lesson 3 - Playing Notes", "l3ex1_leah_", description,
"1eW593Af0VIVh-qDRspjArM0yqpBUAufh")
###################################################################################
with open('l4ex1_leah.json') as outfile:
    submissions = json.load(outfile)
description = """
...
"""
process_exercise(
    submissions, "Lesson 4 - Playing Scales", "l4ex1_leah_", description,
"11j5Daw8Tolxg3mcKaY6r456QiRI3otlO")
###################################################################################
with open('l5ex1_leah.json') as outfile:
    submissions = json.load(outfile)
description = """
...
"""
process_exercise(
    submissions, "Lesson 5 - Playing Chords", "l5ex1_leah_", description,
