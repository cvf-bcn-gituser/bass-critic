...
# Ranking:
#Pitch issues:
#['pitch/chord colorization: false error', 60, 26%],
#['pitch/chord colorization: unaccountable penalization',  8,  3%],
#['pitch/chord colorization: error unrecognized', 3, 1%],
...
with open("pitch_issues.json", "w") as af:
...
with open("pitch_issues_ideal.json", "w") as af:
    json.dump(ideal, af, indent=4)

with open("pitch_issues_ideal.json") as af:
    ideal = json.load(af)
