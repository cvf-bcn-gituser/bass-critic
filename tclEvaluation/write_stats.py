...
def write_stats(deviationsArray1,deviationsArray2,title_text1,title_text2,student_grades,sp,sr,sf,song):
  ...
  fname = DATA_PATH + dash + STATS_PATH + dash + 'StudentStatistics_'+ song + '.csv'
...
# For Brown Eyed Girl
def write_stats_brown(deviationsArray1,deviationsArray2,title_text1,title_text2,student_grades,sp,sr,sf,song):
  ...
  fname = '../data/StudentStatistics_blend_'+ song + '.csv'
  with open(fname, 'w', encoding='UTF8') as f:
     writer = csv.writer(f)
     # write the header
     writer.writerow(header)
...
def write_sop_stats_wotm(deviationsArray1,title_text1,student_grades,sp,sr,sf,song):
  header = ["Student","precision","recall","f_measure_value","Onset ABS Mean","Onset Mean","Onset Std",
         "Duration ABS Mean","Duration Mean","Duration Std","onsetMark"," DurationMark"," articulationMark ","soundQualityMark"," finalMark"]
...
def write_stem_stats(deviationsArray1,deviationsArray2,title_text1,title_text2,precision,recall,fmeasure,song):
  ...
  fname = '../data/StemStatistics_blend_'+ song + '.csv'
  with open(fname, 'w', encoding='UTF8') as f:
    writer = csv.writer(f)
    # write the header
    writer.writerow(header)
...
# Write IEC stats
def write_stats_wotm(deviationsArray1,deviationsArray2,title_text1,title_text2,student_grades,sp,sr,sf,song,dur_AccuracyMeasurements):
  header = ["Student","precision","recall","f_measure_value","Onset ABS Mean","Onset Mean","Onset Std",
         "Duration ABS Mean","Duration Mean","Duration Std", "Dur Acc","onsetMark"," DurationMark"," articulationMark ","soundQualityMark"," finalMark"]
  ...
  with open(fname, 'w', encoding='UTF8') as f:
     ...
     for k in range(len(student_grades)):
        ...
        title =   "Student " + str(k+1)+ title_text2
        #print("duration_summary: ",duration_summary)
        duration_X.append( student_grades[k][1])  # Martis mark
        duration_mean.append(duration_m)
        duration_amean.append(duration_am)
        duration_std.append(duration_s)
        ...
        studentStatistics.append(round(duration_m,3)) 
        studentStatistics.append(round(duration_s,3))
        studentStatistics.append(dur_AccuracyMeasurements[k])		
        studentStatistics.append(student_grades[k][0])
        studentStatistics.append(student_grades[k][1])
        studentStatistics.append(student_grades[k][2])
        studentStatistics.append(student_grades[k][3])
...
# Write IEC stem stats
def write_stem_stats_brown(deviationsArray1,deviationsArray2,title_text1,title_text2,precision,recall,fmeasure,song):
  header = ["Stem","precision","recall","f_measure_value","Onset ABS Mean","Onset Mean","Onset Std",
         "Duration ABS Mean","Duration Mean","Duration Std","onsetMark"," DurationMark"," articulationMark ","soundQualityMark","volumeControlMark"," finalMark"]
  ...
  # Write IEC stem stats
def write_stem_stats_wotm(deviationsArray1,deviationsArray2,title_text1,title_text2,precision,recall,fmeasure,song):
  header = ["Student","precision","recall","f_measure_value","Onset ABS Mean","Onset Mean","Onset Std",
         "Duration ABS Mean","Duration Mean","Duration Std", "Dur Acc","onsetMark"," DurationMark"," articulationMark ","soundQualityMark"," finalMark"]
  ...
  with open(fname, 'w', encoding='UTF8') as f:
    ...
    groundTruthStatistics.append(str(duration_m)) 
    groundTruthStatistics.append(str(duration_s))   
    groundTruthStatistics.append("1.0")		
    groundTruthStatistics.append("100")
    groundTruthStatistics.append("100")
    groundTruthStatistics.append("100")
    groundTruthStatistics.append("100")
