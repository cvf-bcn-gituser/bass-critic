...
while student_index < 8:
 ...
 sonset_deviations,soffset_deviations, missing_onset_notes, missing_offset_notes, sstolen_onsets = match_onset1(onset_list,sonsetIndex,offset_list,soffsetIndex,matching_window_size)
