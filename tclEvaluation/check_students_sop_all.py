...
while stem_index < len(rhythm_filenames):
  ...
  precision, recall, f_measure_value = evaluate_accuracy(onset_list, onsetStemIndex, 0.02)
  print("\n")
  ...
  while student_index < 4:
     ...
     sprecision, srecall, sf_measure_value = evaluate_accuracy(onset_list, sonsetIndex, 0.02)
